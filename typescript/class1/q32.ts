...
for new_user in new_users:
    # Check if the lowercase version of the new username is in current_users_lower
    if new_user.lower() in current_users_lower:
        print(f"Sorry, the username '{new_user}' is not available. Please enter a new username.")
    else:
        print(f"The username '{new_user}' is available!")

# Note: The comparison is case-insensitive due to the use of the lower() method.
